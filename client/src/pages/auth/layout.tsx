...
export const AuthLayout = ({ children }: LoginProps) => (
  <div className='px-4 min-h-[100vh] flex justify-center md:h-[100vh] py-10  items-center bg-image-container relative'>
    <img
    ...
    <div className='gap-10 p-8 flex h-full flex-row justify-center w-[830px] bg-white rounded-[24px] relative'>
      <div className=' flex-col hidden md:flex justify-center h-auto items-start w-1/2'>
        <img
          draggable='false'
      ...
      <div className='flex flex-col justify-around h-auto w-full md:w-1/2'>
        <div className='flex flex-col justify-center items-end w-auto'>
          <Link to={UtilRoutes.HOME}>
            <img src={cerrar} alt='Close user menu' />
          </Link>
        </div>
        <div className=' flex-col items-center flex justify-center gap-5 h-full'>
          <img
            draggable='false'
            src={logo}
            alt='Logo'
            ...
            width='30%'
          />
          <div className='flex h-auto w-full overflow-y-auto  px-1'>{children}</div>
        </div>
      </div>
    </div>
  </div>

    ...
    <div className='flex flex-col md:flex-row gap-[20px]'>
      <div className='flex flex-col justify-center items-end w-[346px] h-[317px] gap-[20px]'>
        <img
          draggable='false'
          src={C3}
          alt='Reciclaje de equipos electronicos'
        ...
        <Link
          draggable='false'
          to='/auth'
          className='text-xs leading-4 font-semibold text-teal-800 pt-7 select-none'
        >
          Leer Nota
        </Link>
      </div>
      ...
      <div className='flex flex-col justify-center items-end w-[346px] h-[317px] gap-[20px]'>
        ...
        <TextElement
          ...
          className='text-base leading-6 font-semibold text-gray-500'
        >
          El 60% de los argentinos está dispuesto a cambiar sus hábitos
          alimentarios para cuidar el medioambiente.
        </TextElement>
        <Link
          draggable='false'
          to='/auth'
      ...
      <div className='flex flex-col justify-center items-end w-[346px] h-[317px] gap-[20px]'>
        ...
        <TextElement
          ...
          className='text-base leading-6 font-semibold text-gray-500'
        >
          Soluciones ecológicas: cómo adquirir hábitos sustentables para
